		...
		<div class="col-sm-4">
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">Seja bem vindo ao portal de inscrição
						a VIII Jornada de Ciência e Tecnologia da UEZO.</div>
				</div>
			</div>
		</div>
		<div class="col-sm-8">
					...
					<form id="cadastro" action="usuario" method="post">
						...
						<div class="form-group ${hasErrorInMatricula}">
							<label for="matricula">Matricula:</label><br /> <input
								name="matricula" type="text" class="form-control"
								placeholder="Caso seja aluno, preencha aqui sua matrícula" />
							<c:if test="${matriculaInvalida}">
								<div>
									<font color="red">A matrícula inserida é inválida!</font>
								</div>
							</c:if>
						</div>
						<br>
			...
			<div class="col-sm-6">
				...
				<form action="oauth" method="post">
					<div class="jumbotron">
						<div class="form-group">
							<label for="matricula">Entrar com:</label> <input type="hidden"
								name="s" value="FACEBOOK"> <a href="#"><input
			...
			<div class="col-sm-6">
				...
				<form action="login">
					<div class="jumbotron">
						<div class="form-group">
							<label for="matricula">E-mail:</label> <input name="email"
								type="text" class="form-control" />
						</div>
						<div class="form-group">
							<label for="curso">Senha:</label> <input name="senha"
